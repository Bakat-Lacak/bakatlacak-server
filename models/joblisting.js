...
module.exports = (sequelize, DataTypes) => {
  class JobListing extends Model {
    ...
    static associate(models) {
      ...
      JobListing.hasMany(models.JobApplication,{foreignKey: "job_listing_id"})
      JobListing.belongsTo(models.CompanyProfile,{foreignKey: "job_listing_id"})
      JobListing.belongsToMany(models.User,{foreignKey:"job_listing_id", through: models.JobApplication})
      JobListing.belongsToMany(models.Type,{foreignKey: "job_listing_id", through: models.JobType})
    }
  }
  JobListing.init({
